...
working.dir <- "Laubach-Williams/LW_2023_Replication-Code/"

# Location of model code files
code.dir <- "Laubach-Williams/LW_2023_Replication-Code/"
...
data <- read.xlsx(paste0(working.dir, "inputData/Laubach_Williams_current_estimates.xlsx"),
  sheet = "input data",
...
write.table(output.us, paste0(working.dir, "output/LW_output.csv"), quote = FALSE, row.names = FALSE, sep = ",", na = "")
